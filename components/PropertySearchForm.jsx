...
function PropertySearchForm() {
  ...
  return (
    <form
      ...
      className="m-2 mx-auto max-w-2xl w-full flex flex-col md:flex-row items-center"
    >
      ...
      <div className="w-full md:w-2/5 md:pl-2">
        ...
        <select
          id="property-type"
          className="w-full px-4 py-3 rounded-lg bg-white text-purple-800 focus:outline-none focus:ring focus:ring-purple-500"
          value={propertyType}
