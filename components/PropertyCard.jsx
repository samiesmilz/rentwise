...
const PropertyCard = ({ property }) => {
  ...
  return (
    <div className="rounded-xl bg-white shadow-md relative">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-center gap-4 text-purple-700 text-sm mb-4">
          <p>
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-4">
          ...
          <Link
            ...
            className="h-[36px] bg-purple-700 hover:bg-purple-900 text-white px-4 py-2 rounded-lg text-center text-sm"
          >
            Details
          </Link>
        </div>
